...
function PlayerAnim:new(Obj)        
    ...
    if Mesh then
        ...
        if Instance.AnimInstance then
            ...
            Instance.AnimInstance:AddSoundNotify("Run", 0.01, "RunSound", "Data/Audio/PlayerFootstep.wav", 7.0, 0)
            Instance.AnimInstance:AddSoundNotify("Run", 0.35, "RunSound", "Data/Audio/PlayerFootstep.wav", 7.0, 0)
            Instance.AnimInstance:AddSoundNotify("Run", 0.35, "BreathingSound", "Data/Audio/PlayerHeavyBreathing.wav", 10.0, 0)
