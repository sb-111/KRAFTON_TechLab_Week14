...
void UParticleModuleVelocity::Spawn(FParticleEmitterInstance* Owner, int32 Offset, float SpawnTime, FBaseParticle* ParticleBase)
{
	...
	FParticleVelocityPayload& VelPayload =
		PARTICLE_ELEMENT(FParticleVelocityPayload, ParticleBasePtr, ModuleOffsetInParticle);
...
void UParticleModuleVelocity::Update(FModuleUpdateContext& Context)
{
	...
	BEGIN_UPDATE_LOOP
		...
		FParticleVelocityPayload& VelPayload =
			PARTICLE_ELEMENT(FParticleVelocityPayload, ParticleBase, ModuleOffsetInParticle);
